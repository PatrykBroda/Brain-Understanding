...
//
// NOTE: this mirrors artifacts/coach/src/lib/glossary.ts. It is duplicated here
// (rather than imported from a shared workspace lib) because the Expo app's Metro
// bundler has no precedent for consuming workspace TS source and the data is
// small + slow-changing. Keep the two copies in sync when terms change.
